...
unitConverter.conversionTable(
    ...
    [
        {unit: "K",
         converters: {
            // C = K - 273.15
            C: function(K) { return K.minus(273.15).round(10) },
            // F = (K * 1.8) - 459.67
            F: function(K) { return K.times(1.8).minus(459.67).round(10) }
            }
        },
        {unit: "C",
         converters: {
            // K = C + 273.15
            K: function(C) { return C.plus(273.15).round(10) },
            // F = (C * 1.8) + 32
            F: function(C) { return C.times(1.8).plus(32).round(10) }
            }
        },
        {unit: "F",
         converters: {
